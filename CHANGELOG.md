...
## [v2.3.10](https://github.com/UtahGooner/time-clock/compare/v2.3.9...v2.3.10)

- set override text to correct value
- remove requires override flag when the clock action completed correctly.
